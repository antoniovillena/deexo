...
;   exomizer raw -P15 -T0 -b (literals=1) (reuse=0)
;   exomizer raw -P15 -T1 -b (literals=0) (reuse=0)
;   exomizer raw -P47 -T0 -b (literals=1) (reuse=1)
;   exomizer raw -P47 -T1 -b (literals=0) (reuse=1)
;
